...
import { AreaCluster } from '@/components/MapOverlays';
import { Drawer, Tooltip } from '@/components/GlassUI';
import { usePrefersReducedMotion, useCountUp, useScrollReveal, useAnimatedWidth, useStaggeredReveal } from '@/hooks/useAnimations';
import { AREA_PROFILES, type AreaProfile } from '@/data/mockData';
